//Time, with attributes for hours, minutes, and seconds. 
//Include methods to add two Time objects and display the result 
//using just basic classes and overloading
#include<iostream>
using namespace std;
